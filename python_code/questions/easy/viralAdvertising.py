...
def viralAdvertising(n:int):
  # day one shares and likes
  shares = 5
  cumlativeLikes = math.floor(shares/2)
  # day 2 to n shares and likes
  for day in range(1, n):
    shares = math.floor(shares/2) *3
    cumlativeLikes += math.floor(shares/2)
  return cumlativeLikes
    
def viralAdvertisingBetter(n:int):
  # without dupe code
  shares = 5
  cumlativeLikes = 0
  
  for day in range(1, n+1):
    cumlativeLikes += shares //2 # floor function also
    shares = math.floor(shares/2) *3
  return cumlativeLikes

if __name__ == "__main__":
  day = 5
  likes = viralAdvertising(day)
  print(likes)
  likes = viralAdvertisingBetter(day)
  print(likes)
